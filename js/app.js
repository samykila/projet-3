...
ajaxGet("https://api.jcdecaux.com/vls/v1/stations?contract=lyon&apiKey=a1bb8a2d6bce79ce80f96e68686478140bfc9616"),function(response) {
    let butRes = document.getElementById("butReservation");
    const listeStations = JSON.parse(response);

//On teste toutes les stations
    stations.forEach(function(station) {
        let marker = this.colorMarkers(station, carte);
